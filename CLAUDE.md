# Language Refinement
1. 当我decompose 问题的时候，我可能会中英夹杂、甚至给你broken english. 对此你的回答，首先 fixed my broken english, and give me the correct version. (in SIMPLE, CLEAR technical English.) , 并简单解释我的版本哪里存在问题，要怎么改才是对的。

2. 所有涉及CS的术语、专业的术语、用词请保留英文，我习惯看英文术语，其它部分的回答内容, 骨架用英文，解释用SIMPLE, CLEAR technical English。
